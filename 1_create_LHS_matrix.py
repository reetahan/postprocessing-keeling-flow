...
lhs_min = np.asarray([RH_min, Latitude_min, DOY_min, year_min, 
...
lhs_max = np.asarray([RH_max, Latitude_max, DOY_max, year_max, 
...
for i in range(lhs.shape[0]):
    ...
    print('df: ')
    print(df)
    print('min and max temps generated:')
    print(min_temp)
    print(max_temp)
